...
public class HeTApApi {
    ...
    public void scan(Context context,String ssid, String pass, String deviceMode, OnApScanLinstaner onApScanLinstaner,long scanTimeout){
        stop();
        init(context);
        ...
        apScanner.setOnApScanLinstaner(onApScanLinstaner);
        apScanner.startScan();
    }

    public void scan(Context context,String ssid, String pass, String deviceMode, OnApScanLinstaner onApScanLinstaner){
        scan(context,ssid,pass,deviceMode,onApScanLinstaner,100);
    }
