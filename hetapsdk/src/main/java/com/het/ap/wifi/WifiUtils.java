...
//    private void connNoPass(String wifiPassword,String wifiItemSSID){
//        // 没有配置好信息，配置
//        WifiAdmin wiFiAdmin =  mWifiAdmin;
...
//                    ClifeLog.i("uu ConnectWifi " + String.valueOf(wifiConfigList.get(wifiId).status) + "uu@@@ status:0--已经连接，1--不可连接，2--可以连接");//status:0--已经连接，1--不可连接，2--可以连接
//                }
...
//                localWifiManager.reconnect();
                ClifeLog.w("uu=====connectWiFi 连接状态:" + bRet + " wifiId:" + wifiId);
                if (!bRet) {
    ...
    public boolean addNetwork(String ssid, String password) {
        ...
        if (wifi != null) {
            ...
            ClifeLog.i("uu== addNetwork netID = " + netID);//连不加密AP总是返回-1
    ...
    public WifiConfiguration createWifiInfo(String SSID, String password) {
        ...
        ClifeLog.i("uu== ssid=" + SSID + " password=" + password + " Type=" + type);
