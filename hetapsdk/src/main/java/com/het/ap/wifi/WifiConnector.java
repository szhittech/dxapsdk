...
public class WifiConnector {
    ...
    class ConnectRunnable implements Runnable {
        ...
        public ConnectRunnable(String s, String p, WifiCipherType t) {
            ssid = s;
            password = p;
            type = t;
        }
            ...
            try {
                ...
                while (wifiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLING) {
                    try {
                        ...
                        ClifeLog.e("====uu= ConnectRunnable!" + wifiManager.getWifiState());
                        Thread.sleep(100);
                ...
                if (wifiConfig == null) {
                    ...
                    ClifeLog.e("====uu= wifiConfig is null!" );
                    return;
                }
                ...
                ClifeLog.e("====uu=enableNetwork status enable=" + enabled);
                boolean connected = wifiManager.reconnect();
                sendMsg("enableNetwork connected=" + connected);
                sendMsg("连接成功!");
                ClifeLog.e("====uu= 连接成功!" + connected);
            } catch (Exception e) {
    ...
    public boolean conn(String ssid, String password, WifiCipherType type){
